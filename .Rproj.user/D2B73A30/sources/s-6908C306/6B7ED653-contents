...
write.csv(model_data1, file = here('data/model_data1.csv'),
          row.names = F)
...
# Split into three different subsets of predictors
...
# Try logistic regression model on Home_w using 3 different data inputs. Test accuracy of each one
...
# Make and save Adjusted efficiency logistic regression model:
df <- data_AdjE
